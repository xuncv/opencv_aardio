...
Net_config = [{'confThreshold':0.5, 'nmsThreshold':0.4, 'inpWidth':416, 'inpHeight':416, 'classesFile':'coco.names', 'modelConfiguration':'yolov3/yolov3.cfg', 'modelWeights':'yolov3/yolov3.weights', 'netname':'yolov3'},
              ...
              {'confThreshold':0.5, 'nmsThreshold':0.4, 'inpWidth':320, 'inpHeight':320, 'classesFile':'coco.names', 'modelConfiguration':'yolo-fastest-xl.cfg', 'modelWeights':'yolo-fastest-xl.weights', 'netname':'yolo-fastest'},
...
if __name__ == "__main__":
    ...
    parser.add_argument('--imgpath', type=str, default='dog.jpg', help='image path')
    parser.add_argument('--net_type', default=2, type=int, choices=[0, 1, 2, 3])
